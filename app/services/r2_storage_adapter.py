...
class R2StorageAdapter(StorageService):
    ...
    def excluir(self, chave: str) -> bool:
        try:
            ...
            # Nunca levanta — normalmente chamado durante uma compensação
            # (limpeza de objeto já enviado após outra falha), onde uma
            # exceção aqui nunca deve mascarar o erro original que
            # disparou a limpeza. Só registra em log e devolve False para
            # quem precisar decidir algo a partir disso.
